...
- [ ] S0.6 — Security Tool Admission (IN PROGRESS — Capability Review 1: Rust Dependency
      ...
      Capability Review 2: Dedicated Secret Scanning (`S0.3-G007`) — **OWNER DECISION RECORDED /
      GITLEAKS v8.30.0 ADMITTED FOR INSTALLATION AND VERIFICATION / IMPLEMENTATION PENDING** — see
