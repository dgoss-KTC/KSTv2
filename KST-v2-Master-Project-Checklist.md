...
- [ ] S0.6 — Security Tool Admission (IN PROGRESS — Capability Review 1: Rust Dependency
      ...
      Capability Review 2: Dedicated Secret Scanning (`S0.3-G007`) — **IMPLEMENTED /
      AWAITING PROJECT-OWNER ACCEPTANCE** — Gitleaks v8.30.0 ADMITTED / INSTALLED / VERIFIED /
      AWAITING IMPLEMENTATION ACCEPTANCE — see
