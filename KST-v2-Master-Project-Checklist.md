...
- [ ] S0.6 — Security Tool Admission (IN PROGRESS — Capability Review 1: Rust Dependency
      ...
      Capability Review 2: Dedicated Secret Scanning (`S0.3-G007`) — **IMPLEMENTED / AWAITING
      PROJECT-OWNER ACCEPTANCE** (Gitleaks v8.30.0 installed, release-integrity and
      ...
      `S0.3-G007` not yet marked resolved pending owner acceptance) — see
