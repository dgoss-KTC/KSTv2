...
/// <summary>
/// Thrown when Component Detail is requested for a workspace id that does not exist in the
...
/// <c>Kst.Application.Bom.BomWorkspaceNotFoundException</c>/
/// <c>Kst.Application.PartDetail.PartDetailWorkspaceNotFoundException</c>.
/// </summary>
public sealed class ComponentWorkspaceNotFoundException(Guid workspaceId)
