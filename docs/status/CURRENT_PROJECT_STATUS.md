...
Infrastructure
Permission Verification — LOCAL EVIDENCE COMPLETE / AWAITING IT/DBA EVIDENCE — 2026-08-28
(`S0.3-G010` — Partially Verified / Awaiting Authoritative Infrastructure Evidence) — see
...
verification incl. `S0.3-G010` — LOCAL EVIDENCE COMPLETE / AWAITING IT/DBA EVIDENCE — 2026-08-28
(`S0.3-G010` — Partially Verified / Awaiting Authoritative Infrastructure Evidence; **`S0.7-F002`** —
QAD Read Scope Exceeds KST Application Need / Least-Privilege Gap / Needs Human Review) — see
